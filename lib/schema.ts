...
export const users = sqliteTable('user', {
  ...
  isReikiLevel1: integer('isReikiLevel1', { mode: 'boolean' }).default(false).notNull(),
  certificateNumberLevel1: text('certificateNumberLevel1').unique(),
  certificateDateLevel1: integer('certificateDateLevel1', { mode: 'timestamp' }),
  isReikiLevel2: integer('isReikiLevel2', { mode: 'boolean' }).default(false).notNull(),
  certificateNumberLevel2: text('certificateNumberLevel2').unique(),
  certificateDateLevel2: integer('certificateDateLevel2', { mode: 'timestamp' }),
  isAllureReiki: integer('isAllureReiki', { mode: 'boolean' }).default(false).notNull(),
  certificateNumberAllure: text('certificateNumberAllure').unique(),
  certificateDateAllure: integer('certificateDateAllure', { mode: 'timestamp' }),
